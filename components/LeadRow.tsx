...
const LeadRow = () => {
  ...
  return (
    <div className="border-b border-[#E5E7EB] last:border-0 bg-[#F4F4EE] first:rounded-t-md last:rounded-b-md">
        <div className="flex gap-4 px-8 py-4.5 font-bold bg-[#F4F4EE] ">
            {/* id */}
        ...
        {/* date */}
            <div className="text-zinc-500 w-2/12">6:02:23</div>
            {/* camp.name */}
            <div className="text-zinc-500 w-4/12 flex flex-row my-auto gap-2">
                <svg
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                    className="size-4 text-[#1877F2] my-auto"
                    fill="currentColor"
                    >
            ...
            {/* creat.id */}
            <div className="text-zinc-500 w-2/12">2256335</div>
        ...
        <div
            className={`font-medium bg-[#F4F4EE] pl-1/12 flex ml-auto overflow-hidden transition-[max-height,opacity] duration-200 ${
                expanded ? "max-h-64 opacity-100 border-t border-[#E5E7EB]" : "max-h-0 opacity-0"
            }`}
        >
        <div className="px-8 pb-0 text-zinc-500 my-4">
            ...
            <div className="flex flex-row gap-4 "> 
                <input type="text"
                    ...
                    className="mt-3 w-full resize-none rounded-md  bg-white px-4 py-2 text-zinc-700 placeholder:text-zinc-500"
                    />
            </div>
        </div>
        </div>
