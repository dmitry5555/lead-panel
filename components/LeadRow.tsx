  ...
  return (
    ...
    >
      <div className="px-8 pb-4 text-zinc-500">
        Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.
        Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.Комментарий: интересовался стоимостью, перезвонить после 17:00.
      </div>
    </div>
